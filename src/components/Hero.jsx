...
const Hero = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      {/* 🔥 Content layer – Foreground (z=10) */}
      <div className="relative z-10 w-full h-full flex flex-col justify-center items-center px-4 sm:px-8">
        <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-8">
          ...
          <div className="flex-1 text-left">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              ...
              <a href="/Rupesh_Gupta_CV.pdf" download="Rupesh_Gupta_CV.pdf"
          ...
          <motion.div
            ...
            className="flex-shrink-0 w-40 h-40 md:w-56 md:h-56 lg:w-72 lg:h-72 rounded-full overflow-hidden border-4 border-[#915EFF] shadow-2xl shadow-[#915EFF]/40"
          >
