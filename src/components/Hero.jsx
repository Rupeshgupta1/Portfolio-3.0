...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen mx-auto overflow-hidden">
      ...
      {/* 3D Model — always behind text, tablet+ only */}
      ...
      >
        ...
        {/* Desktop only: Profile Photo on right */}
        <motion.div
          initial={{ opacity: 0, y: -30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.3 }}
          className="hidden lg:block flex-shrink-0 w-[200px] h-[200px] xl:w-[260px] xl:h-[260px] rounded-full overflow-hidden border-4 border-[#915EFF] shadow-2xl shadow-[#915EFF]/40 mt-2"
          style={{ zIndex: 10 }}
        >
          <img src={rupeshPhoto} alt="Rupesh Gupta" className="w-full h-full object-cover" />
        </motion.div>
